...
function ensureBuffer(input) {
  ...
  if (typeof input === "number") {
    return _Buffer.Buffer.alloc(input);
  } else if (typeof input === "string") {
    return _Buffer.Buffer.fromUnknown(input);
  } else {
...
function signed(source, previous1) {
...
function crc32(source, previous1) {
