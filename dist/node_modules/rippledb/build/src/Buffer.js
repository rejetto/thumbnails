...
class Buffer extends Uint8Array {
  ...
  static checkBigInt(value, min, max, buf, offset, byteLength) {
  ...
  static checked(length) {
    ...
    if (length >= Buffer.kMaxLength) {
      throw new RangeError("Attempt to allocate Buffer larger than maximum " + "size: 0x" + Buffer.kMaxLength.toString(16) + " bytes");
    }
  ...
  static fromUnknown(value) {
    ...
    throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array. Received type " + typeof value);
  } // a<b: -1
  ...
  internalWriteBigUInt64LE(buf, value, offset, min, max) {
...
_defineProperty(Buffer, "kMaxLength", 0x7fffffff);
